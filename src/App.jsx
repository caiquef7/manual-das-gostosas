...
const FRASES_CIENTIFICAS = [
    "Autocuidado regula o sistema nervoso — não é estética, é fisiologia.",
    "Rituais repetidos reduzem a incerteza percebida pelo cérebro, o cérebro interpreta previsibilidade como segurança.",
    "Segurança percebida reduz cortisol, menos cortisol melhora clareza mental, clareza mental aumenta capacidade de decisão, decidir melhor reduz ansiedade futura.",
    "Pequenos rituais organizam o tempo psicológico, tempo organizado reduz sensação de caos, caos reduzido melhora desempenho cognitivo.",
    "O toque ativa mecanorreceptores ligados ao relaxamento, esses receptores se conectam ao sistema parassimpático.",
    "Sistema parassimpático é o modo 'descansar e recuperar', sem esse sistema, o corpo vive em alerta, alerta constante desgasta o cérebro.",
    "Autocuidado interrompe esse ciclo, a interrupção reduz carga alostática, menor carga alostática aumenta longevidade.",
    "O corpo entende repetição como hábito seguro, hábito seguro reduz vigilância interna.",
    "O olfato tem ligação direta com o sistema límbico, sistema límbico processa emoções e memória, por isso cheiro altera estado emocional imediato.",
    "Cheiros familiares reduzem ativação da amígdala, menos amígdala, menos resposta de ameaça.",
    "Perfume é atalho emocional, o cérebro não analisa cheiro — ele reage.",
    "Reação rápida define sensação corporal, sensação corporal define comportamento, comportamento define percepção externa.",
    "O que você sente altera como você se move, como você se move altera como te percebem.",
    "Postura corporal influencia neurotransmissores, postura mais aberta aumenta sensação de poder, sensação de poder reduz submissão social.",
    "Autocuidado altera postura sem esforço consciente.",
    "O cérebro associa cuidado a valor pessoal, valor percebido altera autoconfiança, autoconfiança altera tomada de risco, tomada de risco controlada melhora oportunidades.",
    "O cérebro busca eficiência energética, ele prefere o que é fácil de processar, isso se chama fluência cognitiva.",
    "O que é fluente parece melhor, aparência organizada aumenta fluência, fluência reduz esforço mental.",
    "Menos esforço mental gera conforto, conforto gera preferência, preferência gera aceitação social, aceitação reduz rejeição percebida.",
    "A pele é um órgão sensorial ativo, estímulos na pele geram respostas neurais, texturas agradáveis reduzem estresse.",
    "Temperatura regula percepção de conforto, água morna ativa receptores térmicos calmantes, esses receptores sinalizam ao hipotálamo.",
    "O hipotálamo regula homeostase, homeostase é equilíbrio interno, equilíbrio interno reduz ansiedade, ansiedade reduzida melhora foco.",
    "O cérebro aprende por associação, repetição cria memória emocional, memória emocional é mais forte que lógica, por isso rituais funcionam.",
    "Ritual é comportamento com significado, significado gera engajamento neural, engajamento neural reforça hábito.",
    "Hábito reduz gasto energético, menos gasto energético aumenta consistência, consistência molda identidade.",
    "Identidade percebida influencia comportamento futuro, você age conforme quem acredita ser.",
    "Autocuidado reforça identidade de valor, identidade de valor aumenta limites pessoais, limites reduzem sobrecarga emocional.",
    "Menos sobrecarga melhora desempenho, desempenho reforça autoestima, autoestima regula humor basal, humor basal define qualidade de vida.",
    "Dopamina não é prazer — é motivação, pequenos rituais liberam dopamina, dopamina aumenta ação.",
    "Ação reduz procrastinação, menos procrastinação reduz culpa, culpa reduz energia mental, energia mental preservada melhora foco.",
    "Foco melhora execução, execução melhora resultado, resultado reforça comportamento.",
    "O cérebro precisa de sinais de segurança constantes, autocuidado é um desses sinais, sem sinal, o corpo entra em alerta.",
    "Alerta constante reduz imunidade, imunidade baixa aumenta inflamação, inflamação afeta humor, humor afeta percepção da realidade.",
    "Autocuidado é uma intervenção biológica no seu futuro.","Você sabia que o autocuidado não é estética, é fisiologia? A ciência comprova que rituais repetidos reduzem a incerteza do cérebro, baixando o seu cortisol e diminuindo a ansiedade.",
