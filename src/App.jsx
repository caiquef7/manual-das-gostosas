...
const MOTIVATIONAL_QUOTES = [
    ...
    "A ciência explica: quando você passa um hidratante, o toque ativa mecanorreceptores que ligam o seu modo 'descansar e recuperar'. Isso reduz o estresse e até aumenta sua longevidade!",
    "Você sabia que o seu perfume é um atalho biológico? O olfato vai direto para o sistema límbico. Um cheirinho gostoso e familiar desativa o alerta de ameaça do cérebro na hora!",
    "A neurociência comprova que a forma como você se cuida altera sua postura inconscientemente. E uma postura mais imponente aumenta a liberação de neurotransmissores ligados à autoconfiança!",
    "Você sabia que o cérebro prefere o que é esteticamente organizado? Manter uma boa aparência aumenta a sua 'fluência cognitiva', reduzindo seu esforço mental e te dando mais clareza nas decisões.",
    "A ciência mostra que a nossa pele é um órgão sensorial ativo. Tomar aquele banho premium sinaliza para o seu hipotálamo que você está segura, reduzindo o caos e melhorando o seu foco.",
    "Você sabia que os seus rituais de beleza liberam dopamina? E a dopamina não é só prazer, é motivação! Cuidar de si mesma te dá a energia mental que faltava para parar de procrastinar.",
    "A biologia é clara: o cérebro precisa de sinais de segurança. Quando você para tudo e se cuida, avisa o seu corpo que não há perigo, o que reduz a inflamação e até aumenta a sua imunidade!",
    "Você sabia que o seu cérebro associa o autocuidado ao seu valor pessoal? A ciência diz que, ao reforçar esse valor, você impõe melhores limites sociais e reduz a sua sobrecarga emocional.",
    "A ciência comprova: o que você sente altera como você se move, e como se move altera como te percebem. O seu glow externo é, literalmente, o reflexo do seu equilíbrio interno!"
];
